...
The optional-v2 branch subsequently made that missing same-row comparison on
the purged January development folds. See
`benchmarks/optional_v2/multi_year_same_rows.json`: v1.1.0 MAE is 10.095 MWh,
while this 24-hour-delayed historical candidate is 78.222 MWh. The January
final period was not scored for this candidate.
